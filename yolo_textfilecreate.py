...
file1 = open(txt_filename,"w")#append mode
flag = 1
...
for (video_name_Jpeg , video_name_anno) in zip(list_videos_imagefolder, list_videos_annofolder ):
    ...
    #print( "anno_filenames:::", anno_filenames )
    frame_number = []
...
if txt_filename in os.listdir(root_dir):
    os.remove( os.path.join(root_dir ,txt_filename ))
    shutil.copy( os.path.join(  r"C:\Users\azure.lavdierada\YoloV3" , txt_filename) , root_dir)
else:
    shutil.copy( os.path.join(  r"C:\Users\azure.lavdierada\YoloV3" , txt_filename) , root_dir)
