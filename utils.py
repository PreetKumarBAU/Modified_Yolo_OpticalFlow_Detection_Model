...
def get_evaluation_bboxes(
    ...
    all_pred_boxes = []
    all_true_boxes = []
    for batch_idx, (x, y, l1 , a , b, c ) in enumerate(tqdm(loader)):
...
def check_class_accuracy(model, loader, threshold):
    ...
    for idx, (x, y, l1 , a , b, c ) in enumerate(tqdm(loader)):
...
def get_loaders(train_csv_path, test_csv_path, eval_csv_path):
